...
/* ISVISIBLEONTAG is new from attachtop, ISVISIBLE is modified by it */
...
static void columns_layout(Monitor *m);
...
/* from https://dwm.suckless.org/patches/attachtop/dwm-attachtop-6.2.diff */
void
attachtop(Client *c)
{
	int n;
